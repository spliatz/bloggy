...
var (
	...
	ErrWrongEmail          = NewHTTPError(http.StatusBadRequest, errors.New("email is incorrect"))
	ErrWrongPhone          = NewHTTPError(http.StatusBadRequest, errors.New("phone is incorrect"))
